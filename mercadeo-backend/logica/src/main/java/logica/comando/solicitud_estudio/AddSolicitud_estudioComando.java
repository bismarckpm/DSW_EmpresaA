...
public class AddSolicitud_estudioComando extends BaseComando {
    ...
    public void execute() {
        ...
        try {
            ...
            Solicitud_estudio solicitud_estudio = Solicitud_estudioMapper.mapDtoToEntityInsert(this.solicitud_estudioDto);
            Solicitud_estudio resul = dao.insert( solicitud_estudio );
            this.solicitud_estudioDto=Solicitud_estudioMapper.mapEntityToDto(resul);
